        ...
        for split in self.split.split("+"):
            ...
            if split == "train":
                with _disable_datamanager_setup(data_manager_config._target):  # pylint: disable=protected-access
                    datamanager = data_manager_config.setup(test_mode="test", device=pipeline.device, image_encoder=pipeline.datamanager.image_encoder)
                ...
                with _disable_datamanager_setup(data_manager_config._target):  # pylint: disable=protected-access
                    datamanager = data_manager_config.setup(test_mode=split, device=pipeline.device, image_encoder=pipeline.datamanager.image_encoder)
