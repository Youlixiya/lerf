...
CUDA_VISIBLE_DEVICES=2 ns-train lerf --data data/ovs3d/table
...
CUDA_VISIBLE_DEVICES=2 ns-train lerf --data data/messy_rooms/large_corridor_50
CUDA_VISIBLE_DEVICES=0 ns-train lerf --data data/messy_rooms/large_corridor_100